...
public class hospitalSwitchActivity extends AppCompatActivity {
    ...
    public class SDKReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
                Toast.makeText(hospitalSwitchActivity.this,"apikey验证失败，地图功能无法正常使用",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_OK)) {
                Toast.makeText(hospitalSwitchActivity.this,"apikey验证成功",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
                Toast.makeText(hospitalSwitchActivity.this,"网络错误",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_switch);
...
//        Button geocoder = (Button) findViewById(R.id.btn_geocoder);
        ...
        searchPoi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(hospitalSwitchActivity.this, PoiSearchDemo.class);
        ...
        searchDistrict.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hospitalSwitchActivity.this,DistrictSearchDemo.class);
                startActivity(intent);
            }
        });
        searchRouteplan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(hospitalSwitchActivity.this, RoutePlanDemo.class);
                startActivity(intent);
            }
        });
