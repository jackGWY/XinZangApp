...
public class hospitalActivity extends FragmentActivity implements
    ...
    public class SDKReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
                Toast.makeText(hospitalActivity.this,"apikey验证失败，地图功能无法正常使用",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_OK)) {
                Toast.makeText(hospitalActivity.this,"apikey验证成功",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
                Toast.makeText(hospitalActivity.this,"网络错误",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(hospitalActivity.this, "未找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(hospitalActivity.this, strInfo, Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(hospitalActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
                    .show();
        } else {
            Toast.makeText(hospitalActivity.this, result.getName() + ": " + result.getAddress(), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    public void onGetSuggestionResult(SuggestionResult res) {
        ...
        sugAdapter = new ArrayAdapter<String>(hospitalActivity.this, android.R.layout.simple_dropdown_item_1line, suggest);
        keyWorldsView.setAdapter(sugAdapter);
