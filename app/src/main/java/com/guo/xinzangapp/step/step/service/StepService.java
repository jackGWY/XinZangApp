package com.guo.xinzangapp.step.step.service;
...
import com.guo.xinzangapp.step.step.UpdateUiCallBack;
import com.guo.xinzangapp.step.step.accelerometer.StepCount;
import com.guo.xinzangapp.step.step.accelerometer.StepValuePassListener;
import com.guo.xinzangapp.step.step.bean.StepData;
import com.guo.xinzangapp.step.step.utils.DbUtils;
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void updateNotification() {
        //设置点击跳转
        Intent hangIntent = new Intent(this, StepMainActivity.class);
